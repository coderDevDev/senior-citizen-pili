            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-[#feffff] to-[#ffffff] p-6 rounded-2xl border-2 border-[#E0DDD8]/50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <Label className="text-[#333333] font-semibold text-sm mb-2 block">
                        Region
                      </Label>
                      <div className="h-14 px-4 border-2 border-[#E0DDD8] rounded-2xl bg-gray-50 flex items-center text-[#666666]">
                        Region V - Bicol
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Barangay Selection */}
                    <div>
                      {role === 'basca' && userBarangay !== senior.barangay ? (
                        // For BASCA users editing a senior from a different barangay - show warning
                        <div>
                          <Label className="text-[#333333] font-semibold text-sm mb-2 block">
                            Barangay <span className="text-red-500">*</span>
                          </Label>
                          <div className="h-14 px-4 border-2 border-orange-200 rounded-2xl bg-orange-50 flex items-center text-[#333333] font-medium">
                            {senior.barangay}
                          ...
                          <p className="text-xs text-orange-700 mt-1">
                            <strong>Warning:</strong> This senior is from {senior.barangay}, but you are assigned to {userBarangay}. 
                            You may have limited edit permissions.
                          </p>
                        </div>
                      ) : role === 'basca' ? (
                        // For BASCA users editing a senior from their own barangay - show as read-only
                        <div>
                          <Label className="text-[#333333] font-semibold text-sm mb-2 block">
                            Barangay <span className="text-red-500">*</span>
                          </Label>
                          <div className="h-14 px-4 border-2 border-[#E0DDD8] rounded-2xl bg-green-50 flex items-center text-[#333333] font-medium">
                            {senior.barangay}
                          ...
                          <p className="text-xs text-green-700 mt-1">
                            This senior is registered in your assigned barangay: <strong>{senior.barangay}</strong>
                          </p>
                        </div>
                      ) : (
                        // For OSCA users, allow barangay selection
                        <BarangaySelect
                          label="Barangay"
                ...
                <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-blue-700 text-sm">
                    ...
                    {role === 'basca' 
                      ? ` As a BASCA member, you can only edit seniors from your assigned barangay: ${userBarangay}.`
