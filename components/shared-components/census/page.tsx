...
interface SharedCensusPageProps {
...
export default function SharedCensusPage({
  role = 'osca',
  primaryColor = '#00af8f',
  userBarangay,
  title = 'Census Management',
  description = 'Demographic tracking and trends for senior citizens'
}: SharedCensusPageProps) {
